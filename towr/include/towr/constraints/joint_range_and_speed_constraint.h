...
class JointRangeAndSpeedConstraint : public TimeDiscretizationConstraint
{
 public:
  using EE = uint;
  ...
  JointRangeAndSpeedConstraint(KinematicModelJoints::Ptr robot_model, double T, double dt,
                                EE ee, const SplineHolder& spline_holder);

  ~JointRangeAndSpeedConstraint() = default;
